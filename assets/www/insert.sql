insert into users values(1, 'John','Wayne', 'password', 'admin@mail.com', true, 1, null, '06641233211', 'imglink', 'erste1');
                                                                                             insert into users values(2, 'Max','Muster', 'password', 'max@mail.com', true, 1, 'Ich bin Informatiker','06741233211', 'imglink', 'erste2');
                                                                                             insert into users values(3, 'Kein','ErsteKunde', 'password', 'kein@mail.com', false, null, null, '06741233211', 'imglink', null);
