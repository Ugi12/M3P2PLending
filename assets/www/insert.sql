insert into users values(1, 'John','Wayne', 'password', 'admin@mail.com', true, null, '06641233211', 'imglink', 'erste1');
insert into users values(2, 'Max','Muster', 'password', 'max@mail.com', true, 'Ich bin Informatiker','06741233211', 'imglink', 'erste2');
